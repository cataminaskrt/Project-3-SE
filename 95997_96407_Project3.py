...
app.layout = html.Div(style={'backgroundColor': 'white'}, children=[
    ...
    dcc.Tabs(id='tabs', value='tab-1', children=[
        ...
        dcc.Tab(label='Data 2024', value='tab-2', children=[
            html.Div([
                html.H2("Data 2024"),
        ...
        dcc.Tab(label='Correlation Matrix', value='tab-4', children=[
            html.Div([
        ...
        dcc.Tab(label='Forecasting Parameters', value='tab-5', children=[
            html.Div([
        ...
        dcc.Tab(label='Models', value='tab-6', children=[
            html.Div([
                html.H2("Models"),
        ...
        dcc.Tab(label='Results of Forecast', value='tab-7', children=[
            html.Div([
        ...
        dcc.Tab(label='Our Best Results', value='tab-8', children=[
            html.Div([
